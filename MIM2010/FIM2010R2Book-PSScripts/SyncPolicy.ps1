...
$pilot_filename = $devWorkDir+"FIM-Dev-Policy.xml"
$production_filename = $prodWorkDir+"FIM-Prod-Policy.xml"
$changes_filename = $prodWorkDir+"PolicyChanges.xml"
$joinrules = @{
...
Write-Host
Write-Host "Sync complete. The next step is to commit the changes using CommitPolicyChanges.ps1."